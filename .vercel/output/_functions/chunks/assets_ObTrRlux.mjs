import { i as VALID_SUPPORTED_FORMATS, n as DEFAULT_OUTPUT_FORMAT, t as DEFAULT_HASH_PROPS } from "./consts_Bl9SxbG4.mjs";
import { B as InvalidImageService, E as ExpectedNotESMImage, I as IncompatibleDescriptorOptions, T as ExpectedImageOptions, V as LocalImageUsedWrongly, _t as AstroError, c as isRemotePath, ht as UnsupportedImageFormat, l as joinPaths, mt as UnsupportedImageConversion, ot as RemoteImageNotAllowed, p as removeQueryString, q as MissingImageDimension, w as ExpectedImage } from "./path_DK5xkd1a.mjs";
import { i as isRemoteAllowed, t as inferRemoteSize } from "./remoteProbe_DUnUSx04.mjs";
...
async function getConfiguredImageService() {
	if (!globalThis?.astroAsset?.imageService) {
		const { default: service } = await import("./sharp_CQVAs_dO.mjs").catch((e) => {
...
//#endregion
export { resolveDefaultOutputFormat as a, resolveSrc as c, parseQuality as i, getImage as n, isESMImportedImage as o, baseService as r, isRemoteImage as s, getConfiguredImageService as t };
