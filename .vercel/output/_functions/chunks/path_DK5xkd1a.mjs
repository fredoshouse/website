...
//#endregion
export { NoMatchingImport as $, ForbiddenRewrite as A, InvalidImageService as B, EndpointDidNotReturnAResponse as C, FailedToFetchRemoteImageDimensions as D, ExpectedNotESMImage as E, ImageMissingAlt as F, MiddlewareNotAResponse as G, LocalsNotAnObject as H, IncompatibleDescriptorOptions as I, MissingMediaQueryDirective as J, MissingGetFontFileRequestUrl as K, InvalidComponentArgs as L, GetStaticPathsExpectedParams as M, GetStaticPathsInvalidRouteParam as N, FontFamilyNotFound as O, GetStaticPathsRequired as P, NoManifestAvailable as Q, InvalidGetStaticPathsEntry as R, ClientAddressNotAvailable as S, ExpectedImageOptions as T, LocalsReassigned as U, LocalImageUsedWrongly as V, MiddlewareNoDataOrNextCalled as W, NoClientOnlyHint as X, MissingSharp as Y, NoImageMetadata as Z, trimSlashes as _, AstroError as _t, fileExtension as a, PrerenderDynamicEndpointPathCollide as at, AstroResponseHeadersReassigned as b, isRemotePath as c, ReservedSlotName as ct, removeBase as d, StaticClientAddressNotAvailable as dt, NoMatchingRenderer as et, removeLeadingForwardSlash as f, UnavailableAstroGlobal as ft, stripRequestBase as g, i18nNoLocaleFoundInPath as gt, slash as h, UnsupportedImageFormat as ht, collapseDuplicateTrailingSlashes as i, PrerenderClientAddressNotAvailable as it, GetEntryDeprecationError as j, FontFileUrlNotFound as k, joinPaths as l, ResponseSentError as lt, removeTrailingForwardSlash as m, UnsupportedImageConversion as mt, collapseDuplicateLeadingSlashes as n, OnlyResponseCanBeReturned as nt, hasFileExtension as o, RemoteImageNotAllowed as ot, removeQueryString as p, UnknownContentCollectionError as pt, MissingImageDimension as q, collapseDuplicateSlashes as r, PageNumberParamNotFound as rt, isInternalPath as s, RenderUndefinedEntryError as st, appendForwardSlash as t, NoMatchingStaticPathFound as tt, prependForwardSlash as u, RewriteWithBodyUsed as ut, ActionNotFoundError as v, isAstroError as vt, ExpectedImage as w, CacheNotEnabled as x, ActionsReturnedInvalidDataError as y, InvalidGetStaticPathsReturn as z };
